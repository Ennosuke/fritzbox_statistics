...
def generate_statistics(month_for_stats):
    ...
    template_data = template_data.replace('%image_days_offline_5min%', file_name_days_offline[7:])
    template_data = template_data.replace('%image_data_overall%', file_name_recv_send[7:])
    template_data = template_data.replace('%image_dev_usage%', file_name_dev_data[7:])
    template_data = template_data.replace('%image_dev_speed%', file_name_dev_speed[7:])
